...
public class SuperPrayerStrategy extends PotionStrategy{
	public SuperPrayerStrategy() {
		super(Potions.SUPER_PRAYER);
	}

	@Override
	protected boolean needsPotion() {
		double restoration = 70 + Math.floor(3.43 * Skills.getRealLevel(Skills.PRAYER));
